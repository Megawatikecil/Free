...
if A[2].error==1 then error() return end 
   ...
   if is64 then    
        x2={'52848000h','72A92E80h','1E270000h','D65F03C0h'}
    else
        x2={'E3020400h','E3440974h','EE070A90h','EEB00A67h','E12FFF1Eh'}
    end
x=x2 HACK(2,2,WS) 
WS=ONOFF(WS)  
end 
...
--███████████████████████
A[8].class="RunDataManager"
A[8].method="get_health"
A[9].class="RunDataManager"
A[9].method="get_maxHealth"

function health()
if A[8].error==1 or A[9].error==1 then error() return end
if is64 then x={'128D2FE0h','72A96300h','1E270000h','D65F03C0h'} else x={'E3090680h','E3440B18h','EE070A90h','EEB00A67h','E12FFF1Eh'} end HACK(8,9,HL) HL=ONOFF(HL) 
end 

--███████████████████████
A[10].class="HeroStateProxy" 
A[10].method="get_levelIndex" 

function level()
if A[10].error==1 then error() return end
if is64 then x={'528008A0h','72A00000h','D65F03C0h'} 
else x={'E3000045h','E3400000h','E12FFF1Eh'} end HACK(10,10,LV) LV=ONOFF(LV) 

end
--███████████████████████
function resource()
gg.alert("This feature is only for VIP")
end
--███████████████████████
